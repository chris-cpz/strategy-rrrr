...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-rrrr?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-rrrr)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-rrrr.git
cd strategy-rrrr
...
```python
from strategy import rrrrStrategy

# Initialize strategy
strategy = rrrrStrategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-rrrr/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-rrrr/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-rrrr/discussions)
